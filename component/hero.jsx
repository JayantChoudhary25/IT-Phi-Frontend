...
{/* mobile */}
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 lg:justify-center lg:items-center gap-x-20 gap-y-10 lg:py-[400px] md:py-[200px] py-[50px] md:mt-0 mt-[80px]">
            <div className="flex flex-col gap-10">
              <h1 className="font-bold leading-[38px] md:leading-[65px] lg:leading-[85px] uppercase text-white">
                Give your
                <p className="">
                  {" "}
