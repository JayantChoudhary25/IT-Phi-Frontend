      ...
      <section className="py-[50px]">
        <div className="container mx-auto">
          <div className="">
            ...
            <div className="md:py-[70px] py-[30px] flex  flex-wrap md:flex-row lg:flex-nowrap  gap-y-10 md:px-0 px-4 justify-center ">
              {cardItems.map((items) => (
                <div
                  className={`rounded-[20px] flex flex-col gap-10 text-center px-[20px] lg:px-[50px] lg:py-[50px] xl:px-[100px] py-[50px] ${
