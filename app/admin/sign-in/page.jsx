...
const AdminLogin = () => {
  ...
  const inputHandler = (e) => {
    setuseDetails({ ...useDetails, [e.target.name]: e.target.value })
  }
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/post-endpoint`, useDetails);
            ...
            <div className="flex flex-wrap items-center">
              <div className="hidden w-full xl:block xl:w-1/2">
                <div className="py-17.5 px-26 text-center">
                  <p className="text-2xl font-bold text-black dark:text-white sm:text-title-xl2 mb-8">
                    ...
                    <div className="flex flex-col justify-center items-center gap-6 px-[20px]">
                      ...
                      <div className="w-full">
                        <input
                          ...
                          disabled={isLoading}
                          className="btn-primary bg-[#133239] w-full text-white  border-none transition hover:bg-opacity-90 cursor-pointer hover:bg-[#61adc5d9]"
                        />
                      </div>
